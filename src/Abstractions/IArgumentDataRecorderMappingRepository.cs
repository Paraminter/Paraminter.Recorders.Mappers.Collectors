...
public interface IArgumentDataRecorderMappingRepository<TParameter, TParameterRepresentation, TRecord, TArgumentData>
{
    /// <summary>Handles building of <see cref="IArgumentDataRecorderMapper{TParameter, TRecord, TArgumentData}"/>.</summary>
    public abstract IArgumentDataRecorderMapperBuilder<TParameter, TRecord, TArgumentData> Builder { get; }

    /// <summary>Collects mappings from parameters to recorders.</summary>
    public abstract IArgumentDataRecorderMappingCollector<TParameterRepresentation, TRecord, TArgumentData> Collector { get; }
}
