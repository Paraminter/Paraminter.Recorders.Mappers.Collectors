...
/// <summary>Handles creation of <see cref="IParameterMappingRepository{TKey, TRecord, TData}"/>.</summary>
/// <typeparam name="TParameter">The type of the key used to identify the mapped parameters.</typeparam>
public interface IParameterMappingRepositoryFactory<TParameter>
{
    /// <summary>Creates a <see cref="IParameterMappingRepository{TKey, TRecord, TData}"/>.</summary>
    ...
    /// <returns>The created <see cref="IParameterMappingRepository{TKey, TRecord, TData}"/>.</returns>
