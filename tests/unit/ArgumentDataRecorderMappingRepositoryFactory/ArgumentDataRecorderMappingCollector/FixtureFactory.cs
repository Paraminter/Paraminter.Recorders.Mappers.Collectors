...
internal static class FixtureFactory
{
    public static IFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData> Create<TParameter, TParameterRepresentation, TRecord, TArgumentData>()
    {
        ...
        return new Fixture<TParameter, TParameterRepresentation, TRecord, TArgumentData>(repository.Collector, repository, parameterRepresentationFactoryMock, parameterRepresentationComparerMock);
    }
        ...
        : IFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData>
    {
        ...
        IArgumentDataRecorderMappingCollector<TParameterRepresentation, TRecord, TArgumentData> IFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData>.Sut => Sut;

        IArgumentDataRecorderMappingRepository<TParameter, TParameterRepresentation, TRecord, TArgumentData> IFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData>.Repository => Repository;
