...
public sealed class TryMapParameter
{
    ...
    {
        var fixture = FixtureFactory.Create<object, object, object, object>((_) => { }, (_) => { }, (_) => { });
    ...
    public void NonExisting_ReturnsNull()
    {
        ...
        var fixture = FixtureFactory.Create<object, object, object, object>((_) => { }, setupParameterComparer, registrator);
