...
public sealed class AddMapping
{
    ...
    private static void Target<TParameter, TParameterRepresentation, TRecord, TArgumentData>(ICollectorFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData> fixture, TParameterRepresentation parameter, IMappedArgumentDataRecorder<TRecord, TArgumentData> recorder) => fixture.Sut.AddMapping(parameter, recorder);
}
