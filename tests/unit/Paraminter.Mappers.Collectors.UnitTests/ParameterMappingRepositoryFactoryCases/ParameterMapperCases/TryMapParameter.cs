...
public sealed class TryMapParameter
{
    ...
    public void NonExisting_ReturnsNull()
    {
        ...
        void registrator(IParameterMappingCollector<object, object, object> collector) => collector.AddMapping(mappedParameterRepresentation, Mock.Of<IMappedArgumentDataRecorder<object, object>>());
    }
    ...
    private static IMappedArgumentDataRecorder<TRecord, TArgumentData>? Target<TParameter, TParameterRepresentation, TRecord, TArgumentData>(IMapperFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData> fixture, TParameter parameter) => fixture.Sut.TryMapParameter(parameter);
}
