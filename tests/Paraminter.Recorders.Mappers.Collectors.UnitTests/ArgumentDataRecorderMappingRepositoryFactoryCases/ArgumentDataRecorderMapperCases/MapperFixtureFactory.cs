...
{
    public static IMapperFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData> Create<TParameter, TParameterRepresentation, TRecord, TArgumentData>(
    ...
    private sealed class MapperFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData>
        : IMapperFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData>
    {
        ...
        IArgumentDataRecorderMapper<TParameter, TRecord, TArgumentData> IMapperFixture<TParameter, TParameterRepresentation, TRecord, TArgumentData>.Sut => Sut;
