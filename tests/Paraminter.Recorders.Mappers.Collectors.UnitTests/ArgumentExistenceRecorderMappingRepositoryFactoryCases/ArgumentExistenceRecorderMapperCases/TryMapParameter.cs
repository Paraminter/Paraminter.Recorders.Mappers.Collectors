...
public sealed class TryMapParameter
{
    ...
    {
        var fixture = MapperFixtureFactory.Create<object, object, object>((_) => { }, (_) => { }, (_) => { });
    ...
    public void NonExisting_ReturnsNull()
    {
        ...
        var fixture = MapperFixtureFactory.Create<object, object, object>((_) => { }, setupParameterComparer, registrator);
    ...
    private static IMappedArgumentExistenceRecorder<TRecord>? Target<TParameter, TParameterRepresentation, TRecord>(
        IMapperFixture<TParameter, TParameterRepresentation, TRecord> fixture,
